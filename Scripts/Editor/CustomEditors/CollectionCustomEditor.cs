...
namespace BrunoMikoski.ScriptableObjectCollections
{
    ...
    public class CollectionCustomEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            // Hide the auto-load toggle (no longer relevant - all collections are Addressable)
            Toggle automaticLoadToggle = root.Q<Toggle>("automatic-loaded-toggle");
            if (automaticLoadToggle != null)
                automaticLoadToggle.style.display = DisplayStyle.None;
            ...
            // Hide the enforce-indirect-access toggle (always available now)
            Toggle enforceIndirectAccessToggle = root.Q<Toggle>("enforce-indirect-access");
            if (enforceIndirectAccessToggle != null)
                enforceIndirectAccessToggle.style.display = DisplayStyle.None;
            ...
            // Hide the addressables toggle (always on now)
            Toggle writeAddressablesToggle = root.Q<Toggle>("write-addressables-load-toggle");
            if (writeAddressablesToggle != null)
        ...
        protected virtual void OnEnable()
        {
            ...
            // Need to cache this before the reorderable list is created
